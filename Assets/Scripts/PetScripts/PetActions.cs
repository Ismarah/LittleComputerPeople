...
public class PetActions : AgentActions
{
    ...
    private void CreateActions()
    {
        ...
        conditions = new Dictionary<WorldState.myStates, bool>();
        conditions.Add(WorldState.myStates.petIsTired, true);

        effects = new Dictionary<WorldState.myStates, bool>();
        effects.Add(WorldState.myStates.petIsTired, false);

        newAction = new Action(gameObject, "Sleep", time, actionEffects, conditions, effects, petBed);
        newAction.AddAnimation("sleep", true);
        myActions.Add(newAction);
        //-----------------------------------------------------------------------
    }
